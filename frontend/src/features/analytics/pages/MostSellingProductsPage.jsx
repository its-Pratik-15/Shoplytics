...
export const MostSellingProductsPage = () => {
    ...
    const fetchProducts = async () => {
        try {
            ...
            const response = await analyticsAPI.getMostSellingProducts(params);
            if (response.success) {
                setProducts(response.data);
            }
        } catch (error) {
            toast.error('Failed to fetch most selling products');
        } finally {
            setLoading(false);
        }
    };
                ...
                {loading ? (
                    ...
                    <Card className="overflow-hidden">
                        <div className="px-6 py-4 border-b border-gray-200">
                            <h3 className="text-lg font-medium text-gray-900">Product Rankings</h3>
                        </div>
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {products.map((item, index) => {
                                        const revenue = item.totalQuantitySold * item.product.sellingPrice;
